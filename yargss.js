...
yargs.command({
    ...
    builder:{
        name: {
            ...
            demandOption: true,
            // type yang di ekspetasikan bukan yang di deklarasikan
            type:'string',
        },
        email: {
            describe:'Contact Email',
            demandOption: false,
            // kalau demandOption nya false bisa diabaikan
            type:'string',
        },
        mobile: {
    ...
    handler(argv){
        ...
        // variable boolean penanda apakah contact baru akan di input ke contacts.JSON
        let success=true;
        //cek duplikasi nama
        ...
        // jika nama belum ada dan format input sesuai tambahkan ke contacts.JSON
        if (success) {
